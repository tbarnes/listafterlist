...
{
    return Lists::getAllListCategories();
}

function grab_lists($limit = 0, $offset = 10, $orderBy = 'DESC')
{
    return Lists::getLists($limit, $offset, $orderBy);
}
